...
storename|Allows you to override the default name for the store|*feature*Store, which is dasherised or classified to generate file and folder names.  This should be a camel cased name.|ng g @testpossessed/ng-schematics:feature-store auth --storename myAuthStore
